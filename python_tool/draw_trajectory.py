...
diff_position_no_noise = np.array(pose_int_no_noise) - np.array(pose_gt[1:8001])
diff_position_noise = np.array(pose_int_noise) - np.array(pose_gt[1:8001])
...
ax1.plot(pose_int_no_noise[:, 0], pose_int_no_noise[:, 1], pose_int_no_noise[:, 2], linewidth=0.8, color='b', label='imu_int_no_noise', linestyle='--')
...
ax3.plot(pose_int_noise[:, 0], pose_int_noise[:, 1], pose_int_noise[:, 2], linewidth=0.8, color='b', label='imu_int_noise', linestyle='--')
