...
diff_euler_int_no_noise_rad = np.array(euler_int_no_noise) - np.array(euler_gt[1:8001])
...
diff_euler_int_noise_rad = np.array(euler_int_noise) - np.array(euler_gt[1:8001])
